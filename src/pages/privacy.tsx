    ...
    <div className={'privacy-policy'}>
      <div className="container mx-auto">
        ...
        <p>
          ...
          Duo Tower, Singapore 189352] its related corporations and affiliates (collectively, the
          &quot;Companies&quot;), as well as our respective representatives and/or agents (&quot;Representatives&quot;)
          (the Companies and Representatives collectively referred to herein as &quot;Wave&quot;, &quot;us&quot;,
          &quot;we&quot; or &quot;our&quot;) collecting, using, disclosing and sharing amongst themselves your Personal
          Data, and disclosing such Personal Data to the Companies’ authorised service providers and relevant third
          parties in the manner set forth in this Privacy Policy. In addition, this Privacy Policy will also provide you
          with more information on the basis upon which we may lawfully collect, use and/or disclose your Personal Data
        ...
        <p>
          ...
          rights which we may have at law to collect, use, disclose and/or process your Personal Data. This Privacy
          Policy does not affect any rights which we may have at law in connection with the collection, use, disclosure
        ...
        <p>
          ...
          consistent with our future developments, industry trends and/or any changes in legal or regulatory
          requirements. To the maximum extent permissible under applicable law, you agree to be bound by the prevailing
          terms of this Privacy Policy as may be updated from time to time on our website https://app.waveuniverse.org/,
          and/or as you may be notified. Please check back regularly for updated information on the handling or
        ...
        <p>
          ...
          other personally identifiable information, including the PDPA (collectively, &quot;Data Protection
          Laws&quot;).
        </p>
        <p>
          ...
          documents/certificates, details with respect to shareholders and/or beneficial owners (including their
          personal and contact details; and
          <br />
          <br />• (h)technical information of your device which you use for orders and communication (such as cell
          phone, tablet, notebook, personal computer, IP address).
        </p>
        <p>
        ...
        <p>
          ...
          forms, or when you update or add information to your user profile, whether on our websites or platforms (such
          as the Wave App);
          ...
          <br /> <br />• (c) when you enter into any agreement or provide other documentation or information in respect
          of your interactions and transactions with us, or when you use our services;
          <br /> <br />• (d) when you interact with our staff and Representatives, for example, via telephone calls
          (which may be recorded), letters, fax, face-to-face meetings and email;
          <br /> <br />• (e) when you request that we contact you, be included in an email or other mailing list, or
          when you respond to our request for additional Personal Data, our promotions and other initiatives;
          <br /> <br />• (f) when you are contacted by, and respond to, our marketing representatives and agents and
          ...
          <br /> <br />• (k) when you have subscribed to our newsletter, responded to a survey or filled out any forms
          on our websites or the Wave App;
          <br /> <br />• (l) where you have manifestly chosen to make such Personal Data public, including via any of
          your social media profiles;
          <br /> <br />• (m) when you link any of your account with us with third-party services and applications, such
          as your instant messaging (e.g. WhatsApp) or other social media accounts (e.g. Facebook and Instagram);
        ...
        <p>
          ...
          spouse, children and/or parents), by submitting such information to us, you represent and warrant to us that
          you have obtained the consent of such third party to you providing us with their Personal Data, and for the
          further collection, use, disclosure and/or processing by us of their Personal Data, for the purposes
          contemplated hereunder, and that such consents have not been withdrawn.
        </p>
        <p>
          2.3 You shall ensure that all Personal Data submitted to us is complete, accurate, true and correct. Failure
          on your part to do so may result in our inability to provide you with the products and/or services which you
          have requested.
        </p>
        ...
        <p>
          ...
          <br /> <br />• (f) to improve our customer service and to allow us to more effectively respond to your
          ...
          <br /> <br />• (k) requesting feedback or participation in surveys, as well as conducting market research
          and/or analysis for statistical, profiling or other purposes for us to design our products, understand
          customer behaviour, preferences and market trends, and to review, develop and improve the quality of our
          ...
          promote our respective products and services, where you have consented to receiving information/newsletters
          from us;
          ...
          <br /> <br />• (o) to respond to, handle, and process queries, requests, applications, complaints, and
          feedback from you;
          <br /> <br />• (p) detect, prevent, and address technical issues;
          <br /> <br />• (q) enhance security, monitor and verify identity or service access, combat spam or other
          ...
          <br /> <br />• (u) in connection with any claims, actions or proceedings (including but not limited to
          drafting and reviewing documents, transaction documentation, obtaining legal advice, and facilitating dispute
          resolution), and/or protecting and enforcing our contractual and legal rights and obligations;
          <br /> <br />• (v) complying with any applicable rules, laws and regulations, codes of practice or guidelines
          or to assist in law enforcement and investigations by relevant authorities; and
        ...
        <p>
          ...
          <br /> <br />• (b) providing you with goods and/or services which you have purchased or requested to receive,
          and to push content to you which may be relevant to you (including to personalise and customise your
          experience based on your interactions with our platform(s) and the Wave App, and other content you submit from
          time to time);
          <br /> <br />• (c) communicating with you and informing you of changes and development to the Companies&apos;
          policies, terms and conditions and other administrative information, including for the purposes of servicing
          you in relation to the products and services offered to you;
        ...
        <p>
          3.3 In addition, and without prejudice to the generality of the foregoing, if you submit an application to us
          as a candidate for employment or an internship, or are an existing employee of us, we collect, use, disclose
          and/or process your Personal Data for the following purposes:
          ...
          <br /> <br />• (d) to manage or terminate the employment relationship with you or appoint you, including
          without limitation role assessment, job compatibility assessment, career progression and/or management of
          staffing requirements; and/or
        ...
        <p>
          ...
          purposes:
          <br /> <br />• (a) providing or marketing services, products and benefits to you, including promotions,
          loyalty and reward programmes including joint marketing and/or cross promotions with third parties;
          ...
          touchpoints;
          <br /> <br />• (d) recommending, identifying and/or contacting you to inform you of products, services,
          special offers and rewards, either to our customers generally, or which we have identified may be of interest
          to you, or that are or may be relevant to you, in any case including on behalf of third parties, or sharing
          your Personal Data with such third parties or their service providers for them to collect, use, disclose or
          process your Personal Data for any of such purposes; and/or
          <br /> <br />• (e) conducting research, analysis and development activities (including data analytics,
          surveys, product and service development and/or profiling), understanding and analysing customer behaviour,
          location, preferences and demographics for us to offer you products and services as well as special offers and
          marketing programmes which may be relevant to your preferences and profile.
        </p>
        <p>
        ...
        <p>
          ...
          obtain evidence concerning any complain, claim or dispute or any actual or suspected illegal or unlawful
          conduct or to aid in such investigation or evidence gathering by any law enforcement or regulatory
          authorities.
        </p>
        <p>
          3.8 You may withdraw your consent by contacting us using the contact details set out at paragraph 8 below.{' '}
        </p>
        ...
        <p>
          ...
          <br /> <br />• (b) any business partner, investor, assignee or transferee (actual or prospective) to
          facilitate business asset transactions (which may extend to any merger, acquisition or asset sale);
          ...
          <br /> <br />• (e) any business partner, investor, assignee or transferee (actual or prospective) to
          facilitate business asset transactions (which may extend to any merger, acquisition or any debt or asset sale)
          ...
          <br /> <br />• (i) relevant government regulators, government ministries, statutory boards or authorities
          and/or law enforcement agencies, to comply with any directions, laws, rules, guidelines, regulations or
          schemes issued or administered by any of them;
        ...
        <p>
          ...
          parties:
          <br /> <br />• (a) where in response to a request for your Personal Data in connection with identified
          purposes, you voluntarily provide such Personal Data to us for such purpose(s) and it is reasonable that you
          would voluntarily provide such Personal Data; and
          <br /> <br />• (b) where the collection, use and/or disclosure of your Personal Data is reasonably necessary
          for the conclusion and/or performance of a contract, between you and us or any other organisation entered into
          at your request, which may include recipients of your Personal Data not indicated in this Privacy Policy.
        </p>
        <h2>6. OTHER BASES FOR HANDLING OR PROCESSING YOUR PERSONAL DATA</h2>
        <p>
          6.1 In addition to and without limiting the consents you have provided to our collection, use and/or
          disclosure of your Personal Data for the purposes set out elsewhere in this Data Protection Policy, where
          permitted by applicable law, Wave App may also in accordance the requirements thereof also collect, use and/or
          disclose your Personal Data as further detailed below including without consent, where we meet the
          ...
          and any of the Companies may disclose your Personal Data to us, for improving our products, services,
          processes or business, understanding customer preferences and personalising experiences and recommendations
          (regardless whether you are an existing or prospective customer of any of the Companies).
        </p>
        ...
        <p>
          ...
          information with and who carries out services on our behalf. Your information will be retained as is
          reasonably necessary for our business and to comply with our legal or regulatory obligations. Where your data
          is no longer needed, we will either remove it from our systems or depersonalise it so that we cannot identify
          you.
        </p>
        ...
        <p>
          ...
          information confidential. After a transaction, your private information (credit cards, social security
          numbers, financials, etc.) is never kept on file.
        </p>
        <p>
        ...
        <p>
          ...
          information and data; (b) you shall not disable or interfere with any such analytics code and tools; and (c)
          any intellectual property rights of or in the results of such analytics shall vest solely in us. For the
          avoidance of doubt, we may monitor, track and share with third parties your geo-location information obtained
          by any of our websites and platforms for safety, security, technical, marketing and commercial purposes,
          including to provide and improve our products and services.
        </p>
        <p>
          ...
          directory, and the next time you visit the website or platform, your browser will read the cookie and relay
          the information back to the website, platform or element that originally set the cookie. Depending on the type
          of cookie it is, cookies may store user preferences and other information.
          <br /> <br />• (b) Web beacons (also known as pixel tags and clear GIFs) involve graphics that are not
          apparent to the user. Tracking links and/or similar technologies consist of a few lines of programming code
          and can be embedded in our websites or platforms. Web beacons are usually used in conjunction with cookies and
          primarily used for statistical analysis purposes. This technology can also be used for tracking traffic
          patterns on websites and platforms, as well as finding out if an e-mail has been received and opened and to
          see if there has been any response.
        </p>
        <p>
          10.3 Without limiting the generality of the foregoing, we may employ cookies and other technologies as
          follows:
          ...
          <br /> <br />• (c) to better tailor our products and services to your interests and needs. For example,
          cookies information may be identified and disclosed to our vendors and business partners to generate consumer
          insights;
          ...
          example, information about which pages they have viewed, the time the pages were accessed and the time spent
          per web page, your searches for hotels or experiences, bookings you have made, and other actions);
          ...
          <br /> <br />• (h) personalising the website and platform for you, including delivering advertisements which
          may be of particular interest to you and using cookie related information to allow us to understand the
          effectiveness of our advertisements.
        </p>
        <p>
          10.4 We may also collect information about your precise or approximate location as determined through data
          such as your IP address or mobile device&apos;s GPS to offer you an improved user experience. Most mobile
          devices allow you to control or disable the use of location services for applications in the device&apos;s
          settings menu. Wave App may also collect this information even when you are not using the app if this
          connection is enabled through your settings or device permissions.
        </p>
        <p>
          10.5 Some cookies we use are from third party companies to provide us with web analytics and intelligence
          about our websites and platforms. These companies collect information about your interaction with our websites
          and platforms. We use such information to compile statistics about visitors who interact with the websites,
        ...
        <p>
          10.6 If you do not agree to such use of cookies, you can adjust your browser settings. Unless you have
          adjusted your browser settings to block cookies, our system will issue cookies as soon as you visit our site
          or click on a link in a targeted email that we have sent you, even if you have previously deleted our cookies.
        </p>
        <p>
        ...
        <p>
          10.8 If you do not agree to our use of cookies and other technologies as set out in this Data Protection
          Policy, you should delete or disable the cookies associated with our websites and platforms by changing the
          settings on your browser accordingly. However, you may not be able to enter certain part(s) of our websites or
          platforms. This may also impact your user experience while on our websites or platforms.
        </p>
        ...
        <p>
          ...
          permission. If we become aware that we have collected Personal Data from anyone under the age of 13 without
          parental consent, we will take steps to remove such Personal Datafrom our servers.
        </p>
        ...
        <p>
          ...
          or partner companies, you may be submitting it to both us and these business partners. This Privacy Policy
          does not apply to any information that you may provide to third parties, such as through other sites linked to
          our website. We are not responsible for those sites and cannot control the content of what is offered on those
        ...
        <p>
          ...
          including without limitation our reliance on the legitimate interests and/or deemed consent bases of
          collecting, using and/or disclosing your Personal Data as described in this Privacy Policy;
          ...
          <br /> <br />• (d) change your preferences with respect to communications and other information you receive
          from us; or
        ...
        <p>
          ...
          collection, use, and/or disclosure of your Personal Data, depending on the nature of your request, we may not
          be in a position to continue to provide its products or services to you, administer any contractual
          relationship already in place, or perform or conclude an existing or prospective agreement. This may also
          result in the termination of any agreements you have with us, and your being in breach of your contractual
          obligations or undertakings. Our legal rights and remedies in such event are expressly reserved.
        </p>
