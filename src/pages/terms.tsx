  ...
  return (
    <div className={'privacy-policy'}>
      <div className="container mx-auto">
        ...
        <p>
          1.2 Additional terms and conditions may apply to your use and/or access of certain Services on or available
          via any Platform (“Specific Terms”). The Terms and the Specific Terms shall together constitute the
          “Agreement”. We may from time to time amend or vary the terms of this Agreement, which may include [posting
          the amendments at the following URL: [•] and/or providing notice of any amendments via email or any
          Platforms].
        </p>
        <p>
        ...
        <p>
          ...
          <br /> <br />• (c) the headings are inserted for convenience only and shall not affect the construction of
          this Agreement;
          ...
          <br /> <br />• (e) unless the context otherwise requires, words importing the singular shall include the
          plural and vice versa and words importing a specific gender shall include the other genders (male, female or
          neuter).
        </p>
        <p>
        ...
        <p>
          “Platform” : means the Wave mobile application (“Wave App”) designed by [Wave Metaverse Pte. Ltd.] (“Wave”),
          the Wave website available at [•], and such other application, software, website, documentation, electronic
          key, digital certificate, equipment, materials or other electronic tool or platform which Wave makes available
          to access and/or use any Services, including the services, functions, information and/or other material
          (including data, databases, text, graphics, photographs, animations, audio, music, video, links, application
          programming interfaces, source codes, computer programmes or other content) displayed thereon, provided
          thereby, or made available thereunder by or on behalf of Wave;
        </p>
        <p>
          “Services” : means [the services, products and/or functionalities offered by Wave from time to time, or any
          part thereof, which allows you to, among others:
          <br />
        ...
        <p>
          “Wave Marketplace” : means [the marketplace on the Platform for Users to trade, sell and purchase Digital
          Assets and Tickets];
        </p>
        <p>
        ...
        <p>
          ...
          within the Platform and/or any Services. Without prejudice to the generality of the foregoing, we shall have
        ...
        <p>
          ...
          you are an agent for and act on behalf of the corporate/business entity and that you have the legal authority
          to create a legally binding obligation between the said corporate/business entity and us (or any Other User
          (as defined below));
          <br /> <br />• (d) if you are not a natural person, you are duly established and existing under the laws of
        ...
        <p>
          3.3 You acknowledge and agree that any access and/or use of the Platform and/or any Services, whether
          authorised or not, referable to your Account shall be deemed your access and/or use of the same (as the case
          may be).
        </p>
        <p>
          ...
          <br /> <br />• (c) are solely responsible for and shall have a continuing obligation to maintain up-to-date
          and accurate information as you may from time to time submit to us in connection with your access and/or use
          of the Platform and/or any Services, including any information submitted to us in connection with your
          Account.
        </p>
        <p>
          3.5 You further acknowledge and agree that you shall:
          <br /> <br />• (a) safeguard your Account, including but not limited to your credentials and passwords(s),
          which you shall not disclose to any third party, and take all necessary steps to prevent disclosure (whether
          ...
          <br /> <br />• (b) if you keep a record of any Account, exercise all reasonable endeavours to secure such
          record by: (i) keeping the record in a secure electronic or physical location accessible or known only to you;
          and (ii) keeping the record in a place where the record is unlikely to be accessed by any unauthorised person;
          <br /> <br />• (c) if you discover or suspect that any Account is disclosed to or discovered by any
          unauthorised person, or you have any reason for suspecting that the security or confidentiality of any Account
          has been compromised (including without limitation unauthorised use), immediately inform us and request for a
        ...
        <p>
          3.6 We may from time to time introduce any feature where you may use biometric authentication (including
          without limitation fingerprint or facial recognition) on your device (“Biometric Authentication”) to
          authenticate your identity. If you activate any such feature, you further agree that:
        ...
        <p>
          3.7 IF YOU ACCESS AND/OR USE THIS PLATFORM, YOU CONFIRM (AND WE ARE ENTITLED TO ASSUME WITHOUT FURTHER
          INQUIRY) THAT YOU ARE AT LEAST 18 YEARS OF AGE OR OF THE RELEVANT AGE OF MAJORITY UNDER APPLICABLE LAW. IF YOU
          ARE YOUNGER THAN 18 YEARS OF AGE OR THE RELEVANT AGE OF MAJORITY UNDER APPLICABLE LAW (“MINOR”): (A) YOU MUST
          OBTAIN PERMISSION FROM A PARENT OR A LEGAL GUARDIAN (IF APPLICABLE) TO ACCESS AND/OR USE THE PLATFORM AND/OR
          ANY SERVICES; (B) THAT PARENT OR LEGAL GUARDIAN (AS THE CASE MAY BE) MUST AGREE TO THESE TERMS; AND (C) YOU
          CAN ONLY USE THE PLATFORM AND/OR ANY SERVICES ONLY IN CONJUNCTION WITH AND UNDER THE SUPERVISION OR CONSENT OF
          A PARENT OR LEGAL GUARDIAN. IF YOU ARE THE PARENT OR LEGAL GUARDIAN OF A MINOR, YOU MUST ACCEPT THIS AGREEMENT
          ON THE MINOR’S BEHALF AND YOU WILL BE RESPONSIBLE FOR ALL ACCESS AND/OR USE OF ANY PLATFORM UNDER THIS
          AGREEMENT.
        </p>
        <p>
        ...
        <p>
          ...
          may notify you of, in which case your use of those components is governed by such third party terms, in
          addition to the terms under this Agreement.]
        </p>
        <p>
          4.3 To the maximum extent permitted by Applicable Law, you shall not (and shall not knowingly allow, permit,
          or assist any person to):
          <br /> <br />• (a) copy, rent, lease, sub-licence, loan, translate, merge, adapt, vary or modify the Platform
          or any part thereof;
          ...
          <br /> <br />• (c) disassemble, decompile, reverse-engineer, reverse-assemble, attempt to derive the source
          code of, communicate, republish, upload, post, transmit, edit, re-use, adapt, modify, rent, lease, loan, sell,
          ...
          source code), in any form to any person, or operate or use the Platform on behalf of any such person or for
          its benefit, without our prior written consent;
          ...
          <br /> (ii) transmitting or allowing the transmission via the Platform of any unlawful, harmful, vulgar,
          obscene material or any material that encourages conduct that could constitute a criminal offence, give rise
          to civil liability or otherwise violate any Applicable Law; and/or
        ...
        <p>
          4.4 You consent to us accessing and/or using certain functionalities on your device (and the data stored
          therein and on any cloud based or remote storage accounts) for the purposes of providing you with any Services
          and the other purposes set forth in these Terms.
        </p>
        <p>
          ...
          software and communications services necessary for your access and/or use of the Platform and to protect
          against any security or other vulnerabilities which may arise in connection with the use; and
        ...
        <p>
          ...
          discontinue the provision of or remove, whether in whole in part, the Platform and/or any Services and shall
          not be liable if any such upgrade, modification, suspension or alteration prevents you from accessing the
          Platform and/or any Services, or any part or feature thereof.
        </p>
        <p>
          4.7 From time to time we may (but shall not be obliged to) update the Platform to improve performance, enhance
          functionality, reflect changes to the operating system and/or address security issues. Alternatively, we may
          ask you to update the Platform for these reasons. If you choose not to install such updates or if you opt out
          of automatic updates, you may not be able to continue using the Platform, and we may forthwith terminate your
          Account and access to the Platform.
        </p>
        <p>
          4.8 We may at any time from time to time have the right to add or remove any features comprised in the
          Platform in our sole and absolute discretion, or to levy fees or charges for access or continued access to any
          features. You agree that you shall not have any claim or remedy against us in connection with the removal of
          any such feature.
        </p>
        ...
        <p>
          ...
          tickets in respect of the Underlying Assets (&quot;Tickets&quot;). You can trade Tickets on the Wave
          Marketplace by:
        ...
        <p>
          ...
          <br /> <br />• (a) any dispute, cancellation, refund, and/or return in connection with any Transaction shall
          be subject to such additional policies and guidelines as may be prescribed by us from in connection with the
          same from time to time.
        </p>
        <p>
          5.4 You further acknowledge and agree that, to the extent that a Transaction on the Wave Marketplace is
          entered into between you and another User (“Other User”):
          ...
          Transaction and/or any agreements that may be entered into between you and the Other User, even if terms may
          be prescribed by us in respect of such Transactions, and we are not responsible for the acts or omissions of
          the Other User in connection therewith;
          <br /> <br />• (b) we neither endorse nor assume any responsibility or liability arising in connection with
          any such Transaction (or any Digital Asset in respect of which such Transaction is carried out). Save as
          expressly provided under these Terms, we shall not have any obligation in connection with any such
          Transactions;
          <br /> <br />• (c) we:
        ...
        <p>
          ...
          <br /> <br />• (b) [as part of the Wave Marketplace that permits the trading of your Purchased Digital
          Assets];
          <br /> <br />• (c) [•]; or
        ...
        <p>
          6.3 Except for the foregoing license, and unless expressly stated otherwise at the point of sale of the
          relevant Digital Asset and/or Ticket, your purchase of any Digital Asset and/or Ticket does not grant you any
          other rights, title and interest in and to the Underlying Assets, including any and all copyrights, trade mark
          rights, trade secret rights, patent rights, database rights and any other intellectual property and
          proprietary rights therein. Without generality to the foregoing, if the Underlying Assets contains third party
          intellectual property rights (“Third Party IP”), you acknowledge and agree that:
          ...
          need to (and reserve every right to) pass through additional restrictions on your ability to use the
        ...
        <p>
          6.4 You further acknowledge and agree that you shall not, nor permit any third party to do or attempt to do
          any of the foregoing without our (or, as applicable, our licensors’) express prior written consent in each
          case:
          <br /> <br />• (a) [modify the Underlying Assets in any way, including, without limitation, the shapes,
          designs, drawings, attributes, or color schemes];
          <br /> <br />• (b) [use the Underlying Assets to advertise, market, or sell any third party product or
          service];
          ...
          consists of the Underlying Assets];
          <br /> <br />• (f) attempt to trademark, copyright, or otherwise acquire additional intellectual property
          rights in or to the Underlying Assets];
        ...
        <p>
          7.1 Any Transaction made on or through the Platform (including any and all payments made in connection with
          any Digital Assets and/or Tickets on Wave Marketplace) shall be [conducted solely through the Newton
          Blockchain]. We have no liability to you or to any third party for any claims or damages that may arise as a
          result of any Transactions that you engage in on or through the Platform, or any other payment or transactions
          that you conduct via the Newton Blockchain. You are solely responsible for all amounts payable associated with
        ...
        <p>
          7.3 Before you pay any Fees for any Transaction made on or through the Platform (including any and all
          payments made in connection with any Digital Assets on Wave Marketplace), you will have an opportunity to
          review and accept the Fees that you will be charged. All Fees are in [$NEW] and are non-refundable except as
          required by Applicable Law.
        </p>
        <p>
          7.4 We reserve the right to determine the pricing for the Services, including any Fees chargeable. Except as
          expressly set out under applicable refund policies as may be notified to you by us, all sales are final, and
          no returns and/or refunds are permitted. If a return and/or refund is granted for any Transaction, the
          Transaction may be reversed, and you further agree to bear all taxes and other duties payable thereon.
        </p>
        ...
        <p>
          ...
          another User or a notice of intellectual property infringement or other legal instruction for removal, or
          which in our sole and absolute opinion violates this Agreement, or is otherwise illegal or objectionable, or
          any other reason as we may see fit.
        </p>
        <p>
        ...
        <p>
          8.5 When you submit User Content through the Platform and/or any Services, you agree and represent that you
          own that User Content, or that you have received all necessary permissions, clearances from, or are authorised
          by, the owner of any part of the content to submit it to our Platform and/or Services for all purposes
          contemplated under this Agreement, to transmit it from our Platform and/or Services to other third party
          platforms, adopt or integrate any third party content (as the case may be), and grant us all licences in User
          Content as contemplated under this Agreement.
        </p>
        ...
        <p>
          ...
          parties (as the case may be, and as applicable) (“Relevant Owner”), and may not be copied, imitated or used,
          in whole or in part, without the permission of the Relevant Owner.
        </p>
        <p>
          9.2 By your creation, transmission, posting and/or uploading of User Content on or through any Platform, you
          hereby grant to the Wave Group a non-exclusive, worldwide, perpetual, irrevocable, royalty free,
          sub-licensable right to use and exercise any of the rights comprised in any intellectual property and/or other
          rights (including without limitation, rights in copyright, publicity, and database rights) you have in your
          User Content in connection with hosting, using, distributing, modifying, running, copying, publicly
          performing, communicating, displaying, translating and creating adaptations and derivative works of your User
          Content.
        </p>
        <p>
        ...
        <p>
          ...
          product names and designations and other proprietary indicia used as part of any Platform, all of which are
          and remain the property of the Wave Group or the Relevant Owner(s), and the Wave Group or the Relevant
          Owner(s) own and retain, solely and exclusively, all rights, title and interest in and to the Platform, and
          all Platform IPR that we make available to you through the Platform, including but not limited to any and all
          copyrights, trademark rights, trade secret rights, patent rights, database rights and other intellectual
        ...
        <p>
          ...
          aggregators, information providers, or our business partners) (“Third Party Content”). You acknowledge and
          agree that such content is the sole responsibility of the person or entity that makes it available, and we are
          not responsible for such Third Party Content, and we neither have control over the selection thereof, nor do
          we routinely monitor such content. We make no representations or warranties as to the veracity or accuracy of
          such content, the reproduction and use of which may be governed by the Third Party Content provider’s terms of
          use.
        </p>
        <p>
          ...
          liability, whether direct or indirect or any incidental, special, indirect or consequential damages
          whatsoever, including, without limitation, damages for loss of profits or any other commercial damages or
          Losses, for any content provided by any third party, or for your access and/or use of the same.
        </p>
        <p>
        ...
        <p>
          10.4 Links to third party sites and/or applications may be made available on the Platform (“Third Party
          Sites”). We have no control over such Third Party Sites, and you acknowledge and agree that we are not
          responsible for the availability of such external sites or resources, and do not endorse and are not
          responsible or liable for any content, advertising, products, services or materials on or available through
          such Third Party Sites or resources, including Third Party Content. You further acknowledge and agree that we
          shall not be responsible or liable, directly or indirectly, for any damage or loss caused by or in connection
          with access and/or use of or reliance on any content, goods or services on or available through any such Third
        ...
        <p>
          ...
          you any loss of any kind, and you agree that to the maximum extent permitted by law, we shall not be liable
          for any loss or damage of any kind incurred in connection with your use or reliance on any content,
          information or other materials on or available through such third parties.
        </p>
        <p>
          ...
          decision. You should at all times consult your professional advisers and obtain independent verification of
          the information and data contained herein before making any decision based on any such information or data.
          Nothing on the Platform shall be considered or construed as the giving of any advice in respect of, shares,
          stocks, bonds, notes, interests, unit trusts, property trusts, mutual funds or other securities, investments,
          loans, advances, credits or deposits in any jurisdiction.
        </p>
        ...
        <h2>12. INDEMNITY</h2>
        <p>
          12.1 You hereby unconditionally undertake to indemnify, defend and hold us (and/or Wave Group, as well as
          their respective employees, servants, officers, agents, directors, partners and/or permitted assigns)
          (collectively, the “Indemnitees”) harmless from and against any and all Losses which may be sustained,
          instituted, made or alleged against (including without limitation any Claim or prospective Claim in connection
          therewith), or suffered or incurred by any Indemnitee, and which arise (whether directly or indirectly) out of
        ...
        <p>
          ...
          PERFORMANCE, SECURITY, FITNESS FOR A PARTICULAR PURPOSE, CONTINUED AVAILABILITY, OR INTER-OPERABILITY WITH
          OTHER SYSTEMS OR SERVICES, AND NO SUCH WARRANTY OR REPRESENTATION IS GIVEN IN CONJUNCTION WITH THE PLATFORM
          AND ANY SERVICES.
        </p>
        <p>
          13.2 You further agree and acknowledge that:
          <br /> <br />• (a) the access and/or use of the Platform is entirely at your own risk, and the Platform may
          use transmissions over the Internet which are never completely private or secure. You understand that any
          personal data, message or information which you send in the course of the access and/or use of the Platform
          may be made public on the Platform, and also read or intercepted by others;
          ...
          evidence of the same and to have been entered into by you. You shall be solely responsible for all
          transactions to which any digital certificates, tokens or security credentials associated with you have been
          applied; and
        ...
        <p>
          ...
          penalties (or other levies or charges imposed by any governmental or regulatory authority), even if informed
          of the possibility thereof, arising from or in connection with:
          <br /> <br />• (a) your breach of your representations, warranties, undertakings or obligations under this
          Agreement;
        ...
        <p>
          13.4 To the extent not excluded, and/or to the extent not lawfully excluded, the Wave Group’s maximum
          aggregate liability for all Claims, suits, demands, actions or other legal proceedings in connection with this
          Agreement, whether based on an action or claim in contract, negligence, tort or otherwise, shall not exceed
          SGD [•].
        </p>
        ...
        <p>
          ...
          <br /> <br />• (b) any material information provided or representation made by you to us is untrue or
          misleading or otherwise has an adverse material impact on us or other Users;
        ...
        <p>
          15.2 We will duly consider all Infringement Notices submitted in the above manner. In return, you agree that
          you shall not take any legal action or exercise any legal remedy you may have against Wave in respect of any
          Infringing Material, unless you have first given us the Infringement Notice and sufficient opportunity to
          remove the Infringing Material, and thereafter we refuse or fail to remove the Infringing Material within a
          reasonable time. Where we remove the Infringing Material in response to your Infringement Notice, you agree
          not to exercise and you hereby waive, any right of action against Wave under applicable law which you may have
          in respect of any Infringing Material appearing on the Platform prior to such removal by us.
        </p>
        <p>
        ...
        <h2>16. GENERAL</h2>
        <p>
          16.1 Assignment: This Agreement is personal to you, and shall not be assigned or novated either as to the
          whole or any part thereof, without our prior written consent. We may, by notification to you, assign or novate
          the whole or any part of this Agreement to any party, and you shall be deemed to have consented to such
          assignment or novation, which shall be effective on the date that we notify you.
        </p>
        <p>
        ...
        <p>
          ...
          failures or delays in performing our obligations hereunder arising from any cause beyond our control,
          including acts of God, acts of civil or military authority, fires, strikes, lockouts or labour disputes,
          epidemics, pandemics, governmental restrictions, wars, riots, earthquakes, storms, typhoons, floods and
          breakdowns in electronic and computer information and communications systems (“Force Majeure Event”) and in
          the event of any Force Majeure Event, the time for our performance may be extended by us at our sole and
          absolute discretion for a period equal to the time lost by reason of the delay.
        </p>
        <p>
          16.5 Illegality/Severability: The provisions of this Agreement are severable, and if any provision, or any
          portion thereof, is determined by a competent court or tribunal to be illegal, invalid or unenforceable for
          any reason, any remaining portion of that provision, and all other provisions of this Agreement, shall remain
          valid and enforceable to the fullest extent permitted by applicable law in order to give effect to the
        ...
        <p>
          ...
          Agreement shall create, or be deemed to create, a partnership, joint venture or agency relationship between
          the parties to this Agreement.
        </p>
        <p>
          16.7 No Waiver / Cumulative Rights: No omission or delay by a party to this Agreement in exercising any or
          part of its rights under this Agreement shall operate as a waiver thereof. Unless expressly stated otherwise
          (i.e. expressed to be an exclusive right or remedy), the rights and remedies provided in this Agreement are
          cumulative and not exclusive of any rights or remedies (whether provided by law or otherwise).
        </p>
        <p>
          16.8 Third Party Rights: A person who is not a party to this Agreement has no right under the Contracts
